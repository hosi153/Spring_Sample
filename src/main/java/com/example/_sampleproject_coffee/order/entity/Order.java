package com.example._sampleproject_coffee.order.entity;


import com.example._sampleproject_coffee.member.entity.Member;
import com.example._sampleproject_coffee.OrderCoffee;
import com.example._sampleproject_coffee.stemp.entity.Stamp;
...
public class Order {
    ...
    public void addCoffee(OrderCoffee orderCoffee){
